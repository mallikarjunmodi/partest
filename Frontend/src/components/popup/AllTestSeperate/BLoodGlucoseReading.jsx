...
const BgReading = (props) => {
  return (
    <>
      <div className="bginstruction-container">
        <div className="bginstruction-container1">
        <div className="bginstruction2-container2">
          <div className="bginstruction2-container3">
          <span
...
/>
        ...
        <button className="bginstruction2-button button" onClick={props.onExitClick}>
          Exit
        </button>
        <div className="bginstruction2-container4">
          <h1 className="bginstruction2-text">{props.data.timer}</h1>
        </div>
        <h1 className="bginstruction2-text1">Measuring</h1>
      ...
      <style jsx>
        {`
          ...
          .bginstruction2-container2 {
            top: 26.83px;
            left: 35.77px;
            position: absolute;
          }
          .bginstruction2-container3 {
            display: contents;
          }
          .bginstruction2-button {
            top: 342px;
            left: 810px;
            color: #F15151;
            right: 40px;
